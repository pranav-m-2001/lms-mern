            ...
            <div className="flex flex-col md:flex-row items-start  px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
                ...
                <div className="hidden md:flex flex-col items-start w-full">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        <input type="email" placeholder="Enter your email" className="border border-gray-500/30 text-gray-500 placeholder-gray-500 outline-none w-36 h-9 rounded px-2 text-sm" />
                        <button className="bg-blue-600 w-24 h-9 text-white rounded cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </div>
            <p className="py-4 text-center md:text-sm text-white/60">Copyright {new Date().getFullYear()} &copy; Edmy All Rigths Reserved.</p>
        </footer>
    )
}
